...
brew cask install appcleaner caffeine cheatsheet dropbox evernote firefox kaleidoscope kitematic moom mplayerx paragon-ntfs shiori spotify sublime-text the-unarchiver theine tower virtualbox
