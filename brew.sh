...
brew cask install appcleaner caffeine cheatsheet dropbox evernote firefox kaleidoscope kitematic moom mplayerx spotify sublime-text the-unarchiver tower virtualbox
