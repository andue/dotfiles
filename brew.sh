...
brew cask install appcleaner caffeine cheatsheet dropbox evernote firefox kaleidoscope kitematic moom mplayerx paragon-ntfs spotify sublime-text the-unarchiver theine tower virtualbox
